...
print(
    f"ERC20 - {target_contract.functions.name().call()}:{target_contract.functions.symbol().call()}"
)
print(
    f"Total supply:{web3.fromWei(target_contract.functions.totalSupply().call(), 'ether')}"
)
